...
const PricingCard = ({ plan, children, price }) => {
  return (
    <div className='bg-other-white border border-other-line rounded p-[3rem] md:px-[6rem] md:py-[4rem] max-w-[33rem] w-full flex flex-col justify-between mb-[3rem] mr-[3rem] lg:mr-0 lg:mb-0'>
